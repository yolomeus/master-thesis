...
While the probing paradigm recently emerged for understanding how language models encode general linguistic properties, it has yet to be explored how \ti{downstream task} information is stored, especially when fine-tuned. In particular, we're interested in the \ti{text retrieval} problem.

but retrieval which important: google guides how we access information etc
