...
Where $H$ is the number of attention-heads, $||$ denotes concatenation and $W\lay o \in \R^{d_v H \times d}$ is another learned matrix which projects back to the model's original hidden dimension. 
